...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '菜单ID', field: 'id', align: 'center', valign: 'middle', width: '280px'},
        {title: '菜单名称', field: 'name', align: 'center', valign: 'middle', sortable: true, width: '280px'},
        {title: '上级菜单', field: 'parentId', align: 'center', valign: 'middle', sortable: true, width: '100px'},
...
$(function () {
	// baseURL + 'company/listAll' '../../js/modules/sys/test.json'
    var colunms = Menu.initColumn();
    var table = new TreeTable(Menu.id,'../../js/modules/sys/test.json', colunms);
